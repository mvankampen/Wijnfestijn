...
public class AttendanceController {
    ...
    @SuppressWarnings("unchecked") public void makeTable() {
        ...
        surnameCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
        ...
        infixCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
            .setInfix(t.getNewValue()));
        TableColumn<Guest, String> firstnameCol = createColumn("Voornaam", "firstname");
        firstnameCol.setCellFactory(TextFieldTableCell.forTableColumn());
        firstnameCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
        ...
        salutationCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
        ...
        streetCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
        ...
        streetnrCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
        ...
        zipcodeCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
            .setZipcode(t.getNewValue()));
        TableColumn<Guest, String> cityCol = createColumn("Stad", "city");
        cityCol.setCellFactory(TextFieldTableCell.forTableColumn());
        cityCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
            .setCity(t.getNewValue()));
        TableColumn<Guest, String> emailCol = createColumn("Email", "email");
        emailCol.setCellFactory(TextFieldTableCell.forTableColumn());
        emailCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
            .setEmail(t.getNewValue()));
        TableColumn<Guest, String> phoneCol = createColumn("Telefoonnummer", "phone");
        phoneCol.setCellFactory(TextFieldTableCell.forTableColumn());
        phoneCol.setMinWidth(120);
        phoneCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
        ...
        referralCol.setOnEditCommit(t -> ((Guest) t.getTableView().getItems().get(t.getTablePosition().getRow()))
