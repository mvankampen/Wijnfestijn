...
public class HomeView extends AnchorPane implements ControlledScreen {
	...
	public void setUpContentPane() {
		...
		setOrderLink2(new Hyperlink("Invoeren van de persoonlijke bestellijsten (maakt orders en facturen)"));
		getOrderLink2().getStyleClass().add("default_hyperlink");
		setOrderLink3(new Hyperlink("Maak een nieuwe bestellijst aan (doormiddel van een .CSV bestand)"));
